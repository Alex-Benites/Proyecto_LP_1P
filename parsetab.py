...
_lr_productions = [
  ...
  ('asignacion_array -> VARIABLE CORCHETE_IZQ CORCHETE_DER ASIGNAR expresion PUNTO_COMA','asignacion_array',6,'p_asignacion_array','parser.py',60),
  ('declaracion_define -> DEFINE PAREN_IZQ CADENA COMA expresion PAREN_DER PUNTO_COMA','declaracion_define',7,'p_declaracion_define','parser.py',66),
  ('sentencia_echo -> ECHO expresion PUNTO_COMA','sentencia_echo',3,'p_sentencia_echo','parser.py',70),
  ('sentencia_if -> IF PAREN_IZQ condicion PAREN_DER LLAVE_IZQ sentencias LLAVE_DER','sentencia_if',7,'p_sentencia_if','parser.py',77),
  ('sentencia_if -> IF PAREN_IZQ condicion PAREN_DER LLAVE_IZQ sentencias LLAVE_DER ELSE LLAVE_IZQ sentencias LLAVE_DER','sentencia_if',11,'p_sentencia_if','parser.py',78),
  ('condicion -> expresion IGUAL expresion','condicion',3,'p_condicion','parser.py',87),
  ('condicion -> expresion NO_IGUAL expresion','condicion',3,'p_condicion','parser.py',88),
  ('condicion -> expresion MAYOR expresion','condicion',3,'p_condicion','parser.py',89),
  ('condicion -> expresion MENOR expresion','condicion',3,'p_condicion','parser.py',90),
  ('condicion -> expresion MAYOR_IGUAL expresion','condicion',3,'p_condicion','parser.py',91),
  ('condicion -> expresion MENOR_IGUAL expresion','condicion',3,'p_condicion','parser.py',92),
  ('condicion -> IDENTIFICADOR PAREN_IZQ lista_argumentos PAREN_DER','condicion',4,'p_condicion','parser.py',93),
  ('expresion -> expresion MAS expresion','expresion',3,'p_expresion_binaria','parser.py',100),
  ('expresion -> expresion MENOS expresion','expresion',3,'p_expresion_binaria','parser.py',101),
  ('expresion -> expresion MULTIPLICAR expresion','expresion',3,'p_expresion_binaria','parser.py',102),
  ('expresion -> expresion DIVIDIR expresion','expresion',3,'p_expresion_binaria','parser.py',103),
  ('expresion -> PAREN_IZQ expresion PAREN_DER','expresion',3,'p_expresion_parentesis','parser.py',107),
  ('expresion -> NUMERO','expresion',1,'p_expresion_simple','parser.py',111),
  ('expresion -> CADENA','expresion',1,'p_expresion_simple','parser.py',112),
  ('expresion -> VARIABLE','expresion',1,'p_expresion_simple','parser.py',113),
  ('expresion -> IDENTIFICADOR','expresion',1,'p_expresion_simple','parser.py',114),
  ('expresion -> IDENTIFICADOR PAREN_IZQ lista_argumentos PAREN_DER','expresion',4,'p_expresion_llamada_funcion','parser.py',119),
  ('expresion -> CORCHETE_IZQ elementos_array_coma_opt CORCHETE_DER','expresion',3,'p_expresion_array','parser.py',125),
  ('elementos_array_coma_opt -> elementos_array','elementos_array_coma_opt',1,'p_elementos_array_coma_opt','parser.py',131),
  ('elementos_array_coma_opt -> elementos_array COMA','elementos_array_coma_opt',2,'p_elementos_array_coma_opt','parser.py',132),
  ('elementos_array_coma_opt -> <empty>','elementos_array_coma_opt',0,'p_elementos_array_coma_opt','parser.py',133),
  ('elementos_array -> elemento_array','elementos_array',1,'p_elementos_array','parser.py',142),
  ('elementos_array -> elementos_array COMA elemento_array','elementos_array',3,'p_elementos_array','parser.py',143),
  ('elemento_array -> expresion','elemento_array',1,'p_elemento_array','parser.py',151),
  ('elemento_array -> CADENA ARRAY_ASOCIATIVO expresion','elemento_array',3,'p_elemento_array','parser.py',152),
  ('expresion -> VARIABLE CORCHETE_IZQ expresion CORCHETE_DER','expresion',4,'p_expresion_acceso_array','parser.py',159),
  ('expresion -> expresion PUNTO expresion','expresion',3,'p_expresion_concatenacion','parser.py',163),
  ('sentencia_incremento -> VARIABLE MAS MAS PUNTO_COMA','sentencia_incremento',4,'p_sentencia_incremento','parser.py',167),
  ('sentencia_foreach -> FOREACH PAREN_IZQ VARIABLE AS VARIABLE PAREN_DER LLAVE_IZQ sentencias LLAVE_DER','sentencia_foreach',9,'p_sentencia_foreach','parser.py',171),
  ('sentencia_funcion -> FUNCTION IDENTIFICADOR PAREN_IZQ parametros_funcion PAREN_DER LLAVE_IZQ sentencias LLAVE_DER','sentencia_funcion',8,'p_sentencia_funcion','parser.py',175),
  ('parametros_funcion -> VARIABLE','parametros_funcion',1,'p_parametros_funcion','parser.py',182),
  ('parametros_funcion -> parametros_funcion COMA VARIABLE','parametros_funcion',3,'p_parametros_funcion','parser.py',183),
  ('parametros_funcion -> <empty>','parametros_funcion',0,'p_parametros_funcion','parser.py',184),
  ('sentencia_return -> RETURN expresion PUNTO_COMA','sentencia_return',3,'p_sentencia_return','parser.py',194),
  ('sentencia_llamada_funcion -> IDENTIFICADOR PAREN_IZQ lista_argumentos PAREN_DER PUNTO_COMA','sentencia_llamada_funcion',5,'p_sentencia_llamada_funcion','parser.py',198),
  ('lista_argumentos -> expresion','lista_argumentos',1,'p_lista_argumentos','parser.py',202),
  ('lista_argumentos -> lista_argumentos COMA expresion','lista_argumentos',3,'p_lista_argumentos','parser.py',203),
  ('lista_argumentos -> <empty>','lista_argumentos',0,'p_lista_argumentos','parser.py',204),
  ('sentencia_comentario -> <empty>','sentencia_comentario',0,'p_sentencia_comentario','parser.py',214),
]
